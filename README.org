...
[[https://www.gnu.org/software/emacs/][Emacs]] + [[https://exercism.org][Excersim]]
...
In Python track, in most of the exercises, the filename doesn't match the
exercise name. For example, the in the filename in [[https://exercism.org/track/python/guidos-lasagna][Guidos Lasagna]] is
~lasagna.pw~. With `M-x emacsism-set-exercise-filename` by choosing the source
file, the value of ~emacism-exercise-filename~ will be ~lasagna~.
